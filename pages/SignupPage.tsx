    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-100 px-4">
      <div className="w-full max-w-md bg-white p-10 rounded-xl shadow-sm border border-slate-200">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Start managing your team's workflow.</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          <button 
            type="submit"
            disabled={isLoading}
            className="w-full py-3 bg-slate-900 text-white rounded font-bold hover:bg-slate-800 transition-all disabled:opacity-70 flex items-center justify-center gap-2 text-sm"
          >
